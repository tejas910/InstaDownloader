...
public class ReelFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.reel_frament, null);
        mParticularVideo = v.findViewById(R.id.particularReel);
        getReelLink = v.findViewById(R.id.getReelLink);
        getReelBtn = v.findViewById(R.id.getReel);
        downloadReel = v.findViewById(R.id.downloadReel);
        mediaController = new MediaController(getContext());
        mediaController.setAnchorView(mParticularVideo);
        getReelBtn.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void proessData() {
        StringRequest request = new StringRequest(URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                mParticularVideo.setVideoURI(uri);
